...
def main():
    ...
    endpoints=["/dashboard","/alerts","/assets","/ipam/prefixes","/ipam/addresses","/networks","/scans","/scan-profiles","/topology","/vendors","/archives/assets","/auth/mfa/status","/credentials","/sites","/vlans","/network-devices","/routes","/wireless","/device-roles","/reports/options","/smtp/status","/system/monitoring","/passive-connectors","/probes","/device-configurations","/device-configuration-restores"]
