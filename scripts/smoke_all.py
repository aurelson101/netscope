...
def main():
    ...
    endpoints=["/dashboard","/alerts","/assets","/ipam/prefixes","/ipam/addresses","/networks","/scans","/scan-profiles","/topology","/vendors","/archives/assets","/auth/mfa/status","/credentials","/sites","/vlans","/network-devices","/device-roles","/reports/options","/smtp/status","/system/monitoring"]
